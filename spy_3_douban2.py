            ...
            <div class="item">
                <div class="pic">
                    ...
                    <a href="https://movie.douban.com/subject/3011091/">
                        <img width="100" alt="忠犬八公的故事" src="https://img9.doubanio.com/view/photo/s_ratio_poster/public/p524964016.webp" class="">
                    </a>
                </div>
                <div class="info">
                    <div class="hd">
            ...
            <div class="item">
                <div class="pic">
                    ...
                    <a href="https://movie.douban.com/subject/1889243/">
                        <img width="100" alt="星际穿越" src="https://img3.doubanio.com/view/photo/s_ratio_poster/public/p2206088801.webp" class="">
                    </a>
                </div>
                <div class="info">
                    <div class="hd">
        ...
        <li>
            <div class="item">
                ...
                <div class="info">
                    ...
                    <div class="bd">
                        <p class="">
                            导演: 黄东赫 Dong-hyuk Hwang&nbsp;&nbsp;&nbsp;主演: 孔侑 Yoo Gong / 郑有美 Yu-mi Jeong ...<br>
                            2011&nbsp;/&nbsp;韩国&nbsp;/&nbsp;剧情
                        </p>
            ...
            <div class="item">
                <div class="pic">
                    ...
                    <a href="https://movie.douban.com/subject/25662329/">
                        <img width="100" alt="疯狂动物城" src="https://img1.doubanio.com/view/photo/s_ratio_poster/public/p2315672647.webp" class="">
                    </a>
                </div>
                <div class="info">
                    <div class="hd">
            ...
            <div class="item">
                <div class="pic">
                    ...
                    <a href="https://movie.douban.com/subject/1849031/">
                        <img width="100" alt="当幸福来敲门" src="https://img1.doubanio.com/view/photo/s_ratio_poster/public/p1312700628.webp" class="">
                    </a>
                </div>
                <div class="info">
                    <div class="hd">
            ...
            <div class="item">
                <div class="pic">
                    ...
                    <a href="https://movie.douban.com/subject/3319755/">
                        <img width="100" alt="怦然心动" src="https://img3.doubanio.com/view/photo/s_ratio_poster/public/p2220734673.webp" class="">
                    </a>
                </div>
                <div class="info">
                    <div class="hd">
...
;(function() {
    ...
    <!-- dae-web-movie--default-5687667b87-hbwcj-->
...
numbers = soup.find_all('em', class_="")
names = soup.find_all('div', class_="info")
scores = soup.find_all('span', class_="rating_num")
commits = soup.find_all('p', class_="quote")
# print(movies)
print(len(numbers),len(names),len(scores),len(commits))

list_all = []
for i in range(len(numbers)):
    number = numbers[i].text
    name = names[i].find('span', class_="title").text
    score = scores[i].text
    commit = commits[i].text
    URL = names[i].find('a')['href']
    list_all.append([number,name, score, commit, URL])
print(list_all)